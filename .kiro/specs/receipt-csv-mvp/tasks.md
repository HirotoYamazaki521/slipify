...
- [ ] 2.1 Supabase クライアント設定と Auth Middleware の実装
...
- [ ] 5.1 POST /api/receipts Route Handler の実装
...
- [ ] 5.2 レシートアップロード UI ページとフォームコンポーネント
